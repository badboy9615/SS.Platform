...
$(function () {
    ...
    var data = [];
    data.push({ id: 1, pid: 0, text: '传文管理' });
    data.push({ id: 11, pid: 1, text: '传发文件' });
    data.push({ id: 12, pid: 1, text: '传文列表' });
    data.push({ id: 13, pid: 1, text: '收文列表' });

    data.push({ id: 2, pid: 0, text: '工作汇报' });
    data.push({ id: 21, pid: 2, text: '工作汇报' });
    data.push({ id: 22, pid: 2, text: '汇报记录' });
    data.push({ id: 23, pid: 2, text: '汇报审阅' });

    data.push({ id: 3, pid: 0, text: '工作日志' });
    data.push({ id: 31, pid: 3, text: '填写工作日志' });
    data.push({ id: 32, pid: 3, text: '查阅工作日志' });
