...
$(function () {
    var grid = manager=$("#maingrid").ligerGrid({
        ...
        columns: [
        { display: '编码', name: 'Code', align: 'left', width: '16%', minWidth: 60 },
        { display: '名称', name: 'Name', align: 'left', width: '16%', minWidth: 60 },
        { display: 'URL', name: 'Url', align: 'left', width: '17%', minWidth: 60 },
        { display: '备注', name: 'Remark', align: 'left', width: '17%', minWidth: 60 },
        { display: '创建人', name: 'SubBy', align: 'left', width: '17%', minWidth: 60 },
        { display: '创建时间', name: 'SubTime', align: 'left', width: '17%', minWidth: 60, type: 'date' }
